...
<%@ page import="com.bit.security.domain.UserVO" %>
    ...
    if (msg == null || msg.equals("")) {
        ...
        try {
            ...
            if (principal instanceof UserVO)
                System.out.println(" UserVO 객체 맞음 !! ");
            else
                System.out.println(" UserVO 객체 아님.. " + principal.getClass().toString());
            if (principal != null && principal instanceof UserVO) {
                name = ((UserVO) principal).getUsername();
                System.out.println(" UserVO에서 가지고온 이름 ! : " + name);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
                ...
                <div class="card-body">
                    <form action='/loginProcess' method='POST'>
                        <div class="form-group">
                            <label for="Id"> 아이디</label><input type="text" class="form-control" id="username" name="username" placeholder="ID">
                        </div>
                        <div class="form-group">
                            <label for="Password">패스워드</label> <input type="password" class="form-control" id="password" name="password" placeholder="Password">
                        </div>
                        <div class="checkbox">
